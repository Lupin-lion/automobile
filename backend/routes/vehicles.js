...
router.get('/', (req, res) => {
  const vehicles = [
    { id: 1, type: 'car', make: 'Toyota', model: 'Camry', price: 25000, origin: 'foreign', year: 2020, image: 'https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7', contact: 'https://wa.me/1234567890', featured: true },
